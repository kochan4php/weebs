...
const Dropdown = ({ dataDropdown, onClick }) => (
  <div className="group relative">
    ...
    <nav className="border-2 bg-slate-700 invisible border-slate-800 rounded w-60 absolute -left-[105px] top-14 transition-all opacity-0 group-focus-within:visible group-focus-within:opacity-100 group-focus-within:translate-y-1 z-[999]">
      <ul className="py-1">
